...
<div class="row">
    ...
    <div class="col-md-9">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <h3>Поменять роль пользователя и промо-код</h3>
                <hr>
                <?
                ...
                <form method="post">
                    ...
                    <div class="form-group field-dogovor-insured_phone">
                        <label class="control-label">Промо-код</label>
                        <select name="promo" class="form-control">
                            <? foreach ($promoArr as $item){ ?>
                                <option value="<?= $item->name ?>" <? if($item->name === $user->promo_id){echo 'selected';} ?>><?= $item->name ?> (<?= $item->val ?>)</option>
                            <?}?>

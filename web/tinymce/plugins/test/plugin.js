tinymce.PluginManager.requireLangPack("test"), tinymce.PluginManager.add("test", function(e, i) {
    function a() {
        function i(e, i) {
            var a, o, c = t[e];
            a = '<div class="mce-fontawesome-panel-accordion">', a += '<div class="mce-fontawesome-panel-title">' + i + '<span class="mce-fontawesome-panel-accordion-indicator fa-chevron-right"></span></div>', a += '<div class="mce-fontawesome-panel-content">';
            for (var n = 0; n < c.length / u; n++)
                for (var r = 0; r < u; r++) c[n * u + r] && (o = c[n * u + r].id, name = c[n * u + r].name, a += '<div class="mce-icon-cell js-mce-fontawesome-insert" title="' + name + '" data-id="' + o + '"' + ("spinnerIcons" === e ? ' data-spin="true"' : "") + ">", a += '<span class="fa fa-' + o + ("spinnerIcons" === e ? " fa-spin" : "") + '"></span>', a += "</div>");
            return a += "</div>", a += "</div>"
        }

        function a() {
            var i = this.getAttribute("data-id");
            this.hasAttribute("data-spin") && (i += " fa-spin");
            var a = '<span class="fa fa-' + i + '"></span>';
            "" === e.selection.getNode().textContent && (a += "&nbsp;"), e.execCommand("mceInsertContent", !1, a), p.close()
        }
        ...
        function n() {
            if (!document.querySelector(".mce-fontawesome-panel-search")) {
                var e = this.parentNode,
                    i = !1;
                e.classList.contains("mce-fontawesome-panel-accordion-open") && (i = !0);
                for (var a = 0; a < I.length; a++) {
                    I[a].classList.remove("mce-fontawesome-panel-accordion-open"), I[a].querySelector(".mce-fontawesome-panel-content").style.height = "0";
                    var o = I[a].querySelector(".mce-fontawesome-panel-accordion-indicator");
                    o.classList.remove("fa-chevron-down"), o.classList.add("fa-chevron-right")
                }
                if (!i) {
                    var c = e.querySelector(".mce-fontawesome-panel-content");
                    c.style.height = "auto";
                    var n = Math.ceil(c.offsetHeight);
                    c.style.height = "0", e.classList.add("mce-fontawesome-panel-accordion-open"), c.style.transitionDuration = r(n), (o = e.querySelector(".mce-fontawesome-panel-accordion-indicator")).classList.remove("fa-chevron-right"), o.classList.add("fa-chevron-down"), window.getComputedStyle(c).opacity, c.style.height = n + "px"
                }
            }
        }
        ...
        function r(e) {
            var i = e / 300;
            return i > .8 && (i = .8), i < .3 && (i = .3), i + "s"
        }

        function d() {
            var e, i = document.querySelectorAll(".mce-fontawesome-panel-accordion"),
                a = document.querySelectorAll(".mce-fontawesome-panel-content"),
                o = document.querySelectorAll(".js-mce-fontawesome-insert"),
                c = this.value.toLowerCase().replace(" ", "-"),
                n = 0;
            if (this.value.length) {
                for (document.querySelector(".mce-fontawesome-panel").classList.add("mce-fontawesome-panel-search"), e = 0; e < o.length; e++) s(c, o[e]);
                for (e = 0; e < i.length; e++) i[e].classList.add("mce-fontawesome-panel-accordion-open"), i[e].querySelector(".js-mce-fontawesome-insert:not(.js-mce-fontawesome-insert-hidden)") ? i[e].style.display = "" : (i[e].style.display = "none", n++);
                for (e = 0; e < a.length; e++) a[e].style.height = "auto";
                n === i.length ? document.querySelector(".mce-fontawesome-search-noresults").style.display = "block" : document.querySelector(".mce-fontawesome-search-noresults").style.display = "none"
            } else {
                for (document.querySelector(".mce-fontawesome-panel").classList.remove("mce-fontawesome-panel-search"), document.querySelector(".mce-fontawesome-search-noresults").style.display = "none", e = 0; e < o.length; e++) o[e].classList.remove("js-mce-fontawesome-insert-hidden"), o[e].style.display = "";
                for (e = 0; e < i.length; e++) i[e].classList.remove("mce-fontawesome-panel-accordion-open"), i[e].style.display = "";
                for (e = 0; e < a.length; e++) a[e].style.height = "0"
            }
        }

        function s(e, i) {
            var a = i.getAttribute("data-id");
            if (l(e, a)) return i.classList.remove("js-mce-fontawesome-insert-hidden"), void(i.style.display = "");
            for (var o = 0; o < c.length; o++)
                if (c[o].id === a) {
                    if (c[o].filter)
                        for (var n = 0; n < c[o].filter.length; n++)
                            if (l(e, c[o].filter[n])) return i.classList.remove("js-mce-fontawesome-insert-hidden"), void(i.style.display = "");
                    i.classList.add("js-mce-fontawesome-insert-hidden"), i.style.display = "none"
                }
        }
        ...
        for (var m = document.querySelectorAll(".js-mce-fontawesome-insert"), g = 0; g < m.length; g++) m[g].addEventListener("click", a);
        var I = document.querySelectorAll(".mce-fontawesome-panel-accordion");
        for (g = 0; g < I.length; g++) I[g].querySelector(".mce-fontawesome-panel-title").addEventListener("click", n), I[g].querySelector(".mce-fontawesome-panel-content").style.height = "0";
        var b = document.querySelector(".mce-fontawesome-panel-accordion");
        b.classList.add("mce-fontawesome-panel-accordion-open");
        var h = b.querySelector(".mce-fontawesome-panel-content");
        h.style.height = "auto";
        var A = Math.ceil(h.offsetHeight);
        h.style.height = A + "px", h.style.transitionDuration = r(A);
        var W = b.querySelector(".mce-fontawesome-panel-accordion-indicator");
        W.classList.remove("fa-chevron-right"), W.classList.add("fa-chevron-down");
        var w = document.querySelector(".mce-fontawesome-panel .mce-foot .mce-container-body"),
            y = document.createElement("div");
        y.className = "mce-fontawesome-search-container", y.innerHTML = '<input type="search" placeholder="' + o("Search") + '"><div class="mce-fontawesome-search-container-clear"><span class="fa fa-times-circle"></span></div>', w.insertBefore(y, w.firstChild);
        var v = y.querySelector("input");
        v.addEventListener("input", d), v.focus(), document.querySelector(".mce-fontawesome-search-container-clear").addEventListener("click", function() {
            v.value = "", d.call(v), v.focus()
        })
    }
    var o = tinymce.util.I18n.translate,
        c = [{
            name: "Glass",
            id: "glass",
            unicode: "f000",
    ...
    c.sort(function(e, i) {
        return e.id < i.id ? -1 : e.id > i.id ? 1 : 0
    });
    for (var n, t = [], r = 0; r < c.length; r++)
        for (var d = 0; d < c[r].categories.length; d++) n = c[r].categories[d].toLowerCase().replace(/ (.)/g, function(e, i) {
            return i.toUpperCase()
        }), t[n] || (t[n] = []), t[n].push(c[r]);
    e.on("init", function() {
        var a = e.dom.create("link", {
            rel: "stylesheet",
            href: i + "/css/fontawesome.min.css"
        });
